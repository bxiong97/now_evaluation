...
EIGEN_DIR = "/home/yanfeng/github/now_evaluation/sbody/alignment/mesh_distance/eigen"


def setup_extended(
    parallel=True, numpy_includes=True, usr_local_includes=True, **kwargs
):
...
setup_extended(
    ...
    ext_modules=[
        Extension("sample2meshdist", sourcefiles, language="c++", **additional_options)
    ],
    include_dirs=["."],
)
